        ...
        <ul class="flex items-center justify-center">
          <li class="m-2">
            <a
              title="Visit GitHub"
              class="py-3"
              href="https://github.com/venkivijay/Java-Solutions-TCS-Xplore-Proctored-Assessment"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
                class="inline w-5 h-5 mb-1 mr-2 fill-current text-theme-secondary"
                viewBox="0 0 15 15"
          ...
          <li>
            ...
            >
              <svg
                v-if="theme === 'theme-light'"
                class="w-5 h-6 stroke-current text-theme-secondary"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 15 15"
              >
              ...
              <svg
                v-else
                class="w-5 fill-current text-mermaid"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 15 15"
              >
                <path
